         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button style ="margin-top:10px; margin-bottom:10px" class="btn btn-primary" ID="Button1" runat="server" Text="Go" />
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button style ="margin-top:10px; margin-bottom:10px" ID="Button2" class="w-100 btn btn-lg btn-block btn-primary" runat="server" Text="Issue" />
                     </div>
                     <div class="col-6">
                        <asp:Button style ="margin-top:10px; margin-bottom:10px" ID="Button4" class="w-100 btn btn-lg btn-block btn-success" runat="server" Text="Return" />
                     </div>
                  </div>
               </div>
            </div>
