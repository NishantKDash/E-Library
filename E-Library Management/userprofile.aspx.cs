    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                if (result > 0)
                {
                    cmd = new SqlCommand("update book_issue_tbl set member_name=@member_name WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
                ...
                {
                    con.Close();
                    ClientScript.RegisterStartupScript(this.GetType(), "alert_text", "alertn3()", true);
                }
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                Label1.Text = dt.Rows[0]["account_status"].ToString().Trim().ToUpper();
