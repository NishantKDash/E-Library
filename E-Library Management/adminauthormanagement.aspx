...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        <script>
            ...
            function alert() {
                swal("Done!", "Author was successfully added .", "success");
            }

            function alertn() {
                swal("Author Already Exist with this Author ID, try another ID");
            }
            function alertn2() {
                swal("No Author found");
            }
            ...
            function alertu() {
                swal("Done!", "Author was successfully updated.", "success");
            }

            function alertd() {
                swal("Done!", "Author was successfully deleted.", "success");
            }
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="form-group">
                           <asp:TextBox style ="margin-top:10px; margin-bottom:10px" CssClass="form-control" ID="TextBox2" runat="server" placeholder="Author Name"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
